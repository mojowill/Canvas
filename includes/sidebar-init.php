...
if ( ! function_exists( 'the_widgets_init' ) ) {
	function the_widgets_init() {
		...
		register_sidebar( array( 'name' => __( 'Header', 'woothemes' ), 'id' => 'header', 'description' => __( 'Optional widgetized area in your right header', 'woothemes' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3>', 'after_title' => '</h3>' ) );
